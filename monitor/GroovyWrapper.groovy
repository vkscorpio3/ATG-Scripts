...
ant.jar( destfile: destFile, compress: true, index: true ) {
  ...
  zipgroupfileset( dir: GROOVY_HOME, includes: '/.groovy/grapes/jfree/jfreechart/jars/jfreechart-1.0.5.jar' )
  zipgroupfileset( dir: GROOVY_HOME, includes: '/.groovy/grapes/jfree/jcommon/jars/jcommon-1.0.9.jar' )
  zipgroupfileset( dir: GROOVY_HOME, includes: '/.groovy/grapes/org.codehaus.groovy.modules.http-builder/http-builder/jars/http-builder-0.7.jar' )
  // add more jars here
